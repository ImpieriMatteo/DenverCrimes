...
public class Model {
	...
	public List<Adiacenza> getArchi() {
		...
		//"filtro" gli archi, tenendo solo quelli che hanno un peso maggiore del peso medio
	...
	private void cerca(String destinazione, List<String> parziale) {
		...
		//...altrimenti, scorro i vicin dell'ultimo inserito e provo ad aggiungerli uno ad uno
